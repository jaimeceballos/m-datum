...
public class AgroquimicoUsadoDao extends AbstractDao<AgroquimicoUsado, Long> {
    ...
    /** Internal query to resolve the "agroquimicoUsados" to-many relationship of Encuesta. */
    public List<AgroquimicoUsado> _queryEncuesta_AgroquimicoUsados(Long encuestaId) {
        synchronized (this) {
            if (encuesta_AgroquimicoUsadosQuery == null) {
                QueryBuilder<AgroquimicoUsado> queryBuilder = queryBuilder();
                queryBuilder.where(Properties.EncuestaId.eq(null));
                queryBuilder.orderRaw("T.'_id' ASC");
                encuesta_AgroquimicoUsadosQuery = queryBuilder.build();
            }
        }
        Query<AgroquimicoUsado> query = encuesta_AgroquimicoUsadosQuery.forCurrentThread();
